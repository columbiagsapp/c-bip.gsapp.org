	    ...
	    fetch: function(options) {
	      ...
	      if(this.length > 0){
	      	...
	      	for(var i = 0; i < this.length; i++){
	      		var theIdAttribute = this.at(i).idAttribute;
	      		var theID = this.at(i).get(theIdAttribute);
	      		switch(theIdAttribute){
	      			case 'tid':
	      				queryParams.push({ tid : theID });
	      				break;
	      			case 'nid':
	      				queryParams.push({ nid : theID });
	      				break;
	      			case 'fid':
	      				queryParams.push({ fid : theID });
	      				break;
	      		}
